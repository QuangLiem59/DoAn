...
<head>
    ...
    <?php
        ...
        session_start();
        $id=$_GET['id'];
        $donhang=mysqli_query($con,"select * from donhang inner join khachhang on donhang.tendn=khachhang.tendn inner join chitietdh on donhang.madh =  chitietdh.madh where donhang.tendn='$id'");
        $donhang2=mysqli_query($con,"select * from donhang inner join khachhang on donhang.tendn=khachhang.tendn inner join chitietdh on donhang.madh =  chitietdh.madh inner join sanpham on chitietdh.masp=sanpham.masp where donhang.tendn='$id'");
...
<div class="khungdangnhap">
    ...
    <div class="khungct">
    <?php if(mysqli_num_rows($ktr)>0){ ?>
        <div class="khungchitiet">
            <div class="ttchitiet">
                <h3>Mã Đơn : <?php echo $dh['MaDH'] ?></h3>
                <div class="khunggiact">
                    <h3><?php echo $dh['TongTien'] ?> $</h3>
                </div>
                <ul class="nhasxct">
                    <li>Tên Khách Hàng : </li>
                    <li> <a href="#"><?php echo $dh['TENKH'] ?></a></li>
                </ul>
                <ul class="noisxct">
                    <li>Ngày Lập Đơn : </li>
                    <li> <a href="#"><?php echo $dh['NgayLap'] ?></a></li>
                </ul>
               
                <div class="khungtghct">
                   
                        <button class="themghct"><a href="index.php
                            "><i class="fa fa-home"></i> Home </a></button>
                     
                    
                </div>
            </div>
            <div class="khungmotact">
                <div class="dondathang">
                    ...
                    <?php while($b=mysqli_fetch_array($donhang2)){?>
                    <div class="thandondathang">
                        <div class="spg">
                    ...
                    <div class="thandondathang">
                        <div class="spg">
                            ...
                            <div class="tonggia"><?php echo $dh['TongTien'] ?> $</div>
                        </div>
                    </div>
                   
                    <a href="rmod.php?id=<?php echo $dh['MaDH'] ?>" class="nutthanhtoan">Remove Order</a>

                </div>
            </div>
        </div>
                    <?php } else{ ?>
                    <div id="none" style="textAlign:center;width:100%;margin:auto;padding:100px 0">
                    <p style="text-align:center;font-size:40px;margin:auto;">
                    Không Có Đơn Đặt Hàng </br>
                    <button class="themghct"><a href="index.php
                            " style="color:#5f5f79"><i class="fa fa-home"></i> Home </a></button>
                    </p>
                    </div>
                    <?php } ?>
    </div>
