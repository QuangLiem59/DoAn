...
<head>
    ...
    <?php
        ...
        $knsp=mysqli_query($con,"select * from hinhanh inner join sanpham on hinhanh.MaSP=sanpham.MaSP inner join noisx on sanpham.MaNSX=noisx.MaNSX inner join nhasx on sanpham.MaNhaSX=nhasx.MaNhaSX where sanpham.MaSP='$id'");
        $r=mysqli_fetch_array($knsp);
        $chitiet=mysqli_query($con,"select * from chitietsp where MaSP='$id'");
    ...
    <div class="khungbreadcrumb">
        <div class="breadcrumb-tree">
            <ul>
                ...
                <li><a href="Category.php?ct=<?php echo $r['LoaiSP'] ?>"><?php echo $r['LoaiSP']?></a></a></li>
                <li class="active"><?php echo $r['TenSP'] ?></li>
            </ul>
        </div>
    </div>
    <div class="khungct">
        <div class="khungchitiet">
            <div class="ttchitiet">
                ...
                <div class="khunggiact">
                    <h3><?php echo $r['Gia'] ?> $</h3>
                </div>
                <ul class="nhasxct">
                    <li>Nha San Xuat : </li>
                    <li> <a href="#"><?php echo $r['TenNSX'] ?></a></li>
                </ul>
                <ul class="noisxct">
                    <li>Noi San Xuat : </li>
                    <li> <a href="#"><?php echo $r['DienGiai'] ?></a></li>
                </ul>
                <ul class="loaispct">
                    <li>Loai San Pham : </li>
                    <li> <a href="Category.php?ct=<?php echo $r['LoaiSP'] ?>"><?php echo $r['LoaiSP'] ?></a></li>
                </ul>
                <ul class="baohanhct">
                    <li>Bao Hanh : </li>
                    <li> <a href="#"><?php echo $r['TGBH'] ?> Thang</a></li>
                </ul>
                <div class="khungtghct">
                    <?php if (isset($_SESSION['username']) && $_SESSION['username']){?>
                        <button class="themghct"><a href="addcart.php?masp=<?php echo $r['MaSP'] ?>
                            "><i class="fa fa-cart-plus"></i> Add To Cart</a></button>
                    <?php } else{ ?>
                        <button class="themghct taikhoan"><i class="fa fa-cart-plus"></i> Log In</button>
                        <?php } ?>
                    
                </div>
            </div>
            <div class="anhchitiet">
                <div class="khunganhct">
                    <img src="../img/sanpham/<?php echo $r['LinkHA'] ?>" alt="">
                </div>
            </div>
        </div>
    </div>
